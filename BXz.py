...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/mrsabbri?mibextid=ZbWKwL);menu()
			elif rifat in ['8','08']:
				exit('')
			else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[sabbir-OK] '+ids+' | '+pas+'\033[1;32m')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[sabbir-CP] '+ids+' | '+pas+'\33[0;97m')
